...
const sketch = ({context, width, height, frame}) => {
  return ({context, width, height, frame}) => {
    ...
    const m1 = new Mountain(startPoint, endPoint, 'yellow', frame-params.animationOffset);
    ...
    const m4 = new Mountain(startPoint2, endPoint2, 'yellow', frame-params.animationOffset);
    ...
    const m7 = new Mountain(startPoint3, endPoint3, 'yellow', frame-params.animationOffset);
    ...
    const m10 = new Mountain(startPoint4, endPoint4, 'yellow', frame-params.animationOffset);
    ...
    const m13 = new Mountain(startPoint5, endPoint5, 'yellow', frame-params.animationOffset);
